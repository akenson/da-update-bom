...
{
    [Guid("5084ca1c-b6f0-41dc-b21d-f941c556a7ae")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": UpdateBomPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": UpdateBomPlugin: deactivating... ");
